...
#var_dict3 = {'название': 'сканер', 'цена': 2000, 'колличество': 7, 'ед.изм': 'шт'}
    item_tuple = (i, var_dict)
    goods_list.insert(i,item_tuple)
    i += 1
var_tuple1 = goods_list[0]
var_tuple2 = goods_list[1]
var_tuple3 = goods_list[2]
#print(var_tuple1)
#print(var_tuple2)

var_dict1 = (var_tuple1[1])
var_dict2 = (var_tuple2[1])
var_dict3 = (var_tuple3[1])
#output_analize = {'название': goods_list[],
#                  'цена': var_set2,
#                  'количество': var_set3,
#                  'ед.изм': var_set4
#                  }
